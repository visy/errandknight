...
function updateenemies() 
	...
	for i = 1,enemycount do
		...
		dd = abs(dist(enemy.x,enemy.y,player.x,player.y))
		dv = 128
...
function drawlevel()
	...
	for x=-1,16,2 do 
 	...
 	yo = 0
		...
		v1 = cos(c*0.001)
		v2 = sin(c*0.001)
		if v1 > 0.0 then c = 1 end
		if v2 < 0.0 then c = 2 end
		if (c == 1) then pal(1,1)
		pal(2,0)
		else
		pal(2,1)
...
function drawtorch()
 if (player.dead == true) return
	...
	for y=player.y-4,player.y+20 do
	for x=player.x-8,player.x+16 do
		dd = dist(x,y,player.x+4,player.y+8)/0.08
		cc = dd/(21+cos(time()*0.4+sin(time()*0.7)*0.5)*1)
...
--	print(player.moveframes,player.x,player.y-8)
	pal()
	-- actual
	-- level armor colors
	armor = {4,13,12,9,11,10,8}
...

